...
const Slider = () => {
  ...
  return (
    <div className="w-[3.5rem] flex flex-col items-center pt-5 pb-7 justify-between max-md:fixed max-md:-translate-x-14 h-full bg-[#212121] transition-all duration-300 ease overflow-y-auto">
